...
const CustomerManager: React.FC<CustomerManagerProps> = ({ invoices, onSelectInvoice }) => {
  ...
  return (
    <div className="flex h-[calc(100vh-4rem)] gap-6">
        {/* List of Customers */}
        <div className={`w-full ${selectedClientName ? 'hidden md:block md:w-1/3' : ''} bg-white rounded-xl shadow-lg border border-gray-300 overflow-hidden flex flex-col`}>
            <div className="p-5 border-b border-gray-300 bg-gray-50">
                ...
                <div className="relative">
                    <input
                        ...
                        className="w-full pl-10 pr-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-transparent text-sm bg-white"
                    />
        ...
        {/* Customer Details */}
        {selectedClientName ? (
            <div className="flex-1 bg-white rounded-xl shadow-lg border border-gray-300 overflow-hidden flex flex-col">
                 {(() => {
                            ...
                            <div className="flex-1 overflow-y-auto p-6">
                                ...
                                <div className="space-y-3">
                                    {client.invoices.sort((a, b) => b.date.localeCompare(a.date)).map(inv => (
                                        <div 
                                            key={inv.id} 
                                            className="border border-gray-300 rounded-lg p-4 hover:shadow-md transition bg-white flex justify-between items-center"
                                        >
                                            <div>
            ...
            <div className="hidden md:flex flex-1 bg-gray-50 rounded-xl border-2 border-dashed border-gray-300 items-center justify-center text-gray-400">
